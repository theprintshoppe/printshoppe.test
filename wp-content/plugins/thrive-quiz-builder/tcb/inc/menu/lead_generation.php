...
<div id="tve-lead_generation-component" class="tve-component" data-view="LeadGeneration">
    ...
    <div class="dropdown-content">
        ...
        <a class="tcb-hidden info-link toggle-control" target="_blank"
           href="<?php echo admin_url( 'admin.php?page=tve_dash_api_connect' ) ?>">
        ...
        <div class="no-api tve-advanced-controls extend-grey">
            ...
            <div class="dropdown-content clear-top">
                <div class="no-api tcb-text-center">
                    ...
                    <button class="tve-button click long blue multiple-services-connect margin-top-10"
                            data-fn="mServiceConnect">
