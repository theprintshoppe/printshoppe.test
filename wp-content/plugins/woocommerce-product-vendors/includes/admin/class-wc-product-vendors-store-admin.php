...
class WC_Product_Vendors_Store_Admin {
	...
	public static function init() {
		...
		add_filter( 'woocommerce_attribute_label', array( self::$self, 'filter_order_attribute_label' ), 10, 2 );
	...
	public function add_debug_tool( $tools ) {
		...
		$tools['wcpv_delete_webhook'] = array(
			...
			'desc'    => __( 'Troubleshoot PayPal Mass Payout. Delete current webhook and receive new webhook id.', 'woocommerce-product-vendors' ),
		);
