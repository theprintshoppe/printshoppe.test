...
if ( ! class_exists( 'UABB_Plugin_Backward' ) ) {
	...
	class UABB_Plugin_Backward {
		...
		public function uabb_heading( &$settings ) {
			...
			if ( isset( $settings->line_height['small']) && isset( $settings->new_font_size['small']) && $settings->new_font_size['small'] != 0 && !isset( $settings->line_height_unit_responsive ) ) {
			...
			if( isset( $settings->line_height['medium']) && isset( $settings->new_font_size['medium']) && $settings->new_font_size['medium'] != 0 && !isset( $settings->line_height_unit_medium ) ) {
			...
			if( isset( $settings->line_height['desktop']) && isset( $settings->new_font_size['desktop']) && $settings->new_font_size['desktop'] != 0 && !isset( $settings->line_height_unit ) ) {
			...
			if ( isset( $settings->desc_line_height['small']) && isset( $settings->desc_font_size['small']) && $settings->desc_font_size['small'] != 0 && !isset( $settings->desc_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->desc_line_height['medium']) && isset( $settings->desc_font_size['medium']) && $settings->desc_font_size['medium'] != 0 && !isset( $settings->desc_line_height_unit_medium ) ) {
			...
			if( isset( $settings->desc_line_height['desktop']) && isset( $settings->desc_font_size['desktop']) && $settings->desc_font_size['desktop'] != 0 && !isset( $settings->desc_line_height_unit ) ) {
			...
			if ( isset( $settings->separator_text_line_height['small']) && isset( $settings->separator_text_font_size['small']) && $settings->separator_text_font_size['small'] != 0 && !isset( $settings->separator_text_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->separator_text_line_height['medium']) && isset( $settings->separator_text_font_size['medium']) && $settings->separator_text_font_size['medium'] != 0 && !isset( $settings->separator_text_line_height_unit_medium ) ) {
			...
			if( isset( $settings->separator_text_line_height['desktop']) && isset( $settings->separator_text_font_size['desktop']) && $settings->separator_text_font_size['desktop'] != 0 && !isset( $settings->separator_text_line_height_unit ) ) {
		...
		public function uabb_numbers( &$settings ) {
			...
			if ( isset( $settings->num_line_height['small']) && isset( $settings->num_font_size['small'])  && $settings->num_font_size['small'] != 0 && !isset( $settings->num_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->num_line_height['medium']) && isset( $settings->num_font_size['medium'] ) && $settings->num_font_size['medium'] != 0 && !isset( $settings->num_line_height_unit_medium ) ) {
			...
			if( isset( $settings->num_line_height['desktop']) && isset($settings->num_font_size['desktop']) && $settings->num_font_size['desktop'] != 0 && !isset( $settings->num_line_height_unit ) ) {
			...
			if ( isset( $settings->ba_line_height['small']) && isset($settings->ba_font_size['small'])  && $settings->ba_font_size['small'] != 0 && !isset( $settings->ba_line_height_unit_responsive )  ) {
			...
			if( isset( $settings->ba_line_height['medium']) && isset( $settings->ba_font_size['medium'] ) && $settings->ba_font_size['medium'] != 0 && !isset( $settings->ba_line_height_unit_medium ) ) {
			...
			if( isset( $settings->ba_line_height['desktop']) && isset( $settings->ba_font_size['desktop'] ) && $settings->ba_font_size['desktop'] != 0 && !isset( $settings->ba_line_height_unit )) {
		...
		public function uabb_adv_testimonials( &$settings ) {
			...
			if ( isset( $settings->testimonial_heading_line_height['small']) && isset( $settings->testimonial_heading_font_size['small']) && $settings->testimonial_heading_font_size['small'] != 0 && !isset( $settings->testimonial_heading_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->testimonial_heading_line_height['medium']) && isset( $settings->testimonial_heading_font_size['medium']) && $settings->testimonial_heading_font_size['medium'] != 0 && !isset( $settings->testimonial_heading_line_height_unit_medium ) ) {
			...
			if( isset( $settings->testimonial_heading_line_height['desktop']) && isset( $settings->testimonial_heading_font_size['desktop']) && $settings->testimonial_heading_font_size['desktop'] != 0 && !isset( $settings->testimonial_heading_line_height_unit ) ) {
			...
			if ( isset( $settings->testimonial_designation_line_height['small']) && isset( $settings->testimonial_designation_font_size['small']) && $settings->testimonial_designation_font_size['small'] != 0 && !isset( $settings->testimonial_designation_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->testimonial_designation_line_height['medium']) && isset( $settings->testimonial_designation_font_size['medium']) && $settings->testimonial_designation_font_size['medium'] != 0 && !isset( $settings->testimonial_designation_line_height_unit_medium ) ) {
			...
			if( isset( $settings->testimonial_designation_line_height['desktop']) && isset( $settings->testimonial_designation_font_size['desktop']) && $settings->testimonial_designation_font_size['desktop'] != 0 && !isset( $settings->testimonial_designation_line_height_unit ) ) {
			...
			if ( isset( $settings->testimonial_description_opt_line_height['small']) && isset( $settings->testimonial_description_opt_font_size['small']) && $settings->testimonial_description_opt_font_size['small'] != 0 && !isset( $settings->testimonial_description_opt_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->testimonial_description_opt_line_height['medium']) && isset( $settings->testimonial_description_opt_font_size['medium']) && $settings->testimonial_description_opt_font_size['medium'] != 0 && !isset( $settings->testimonial_description_opt_line_height_unit_medium ) ) {
			...
			if( isset( $settings->testimonial_description_opt_line_height['desktop']) && isset( $settings->testimonial_description_opt_font_size['desktop']) && $settings->testimonial_description_opt_font_size['desktop'] != 0 && !isset( $settings->testimonial_description_opt_line_height_unit ) ) {
		...
		public function uabb_hotspot( &$settings ) {
            ...
            for( $i = 0; $i < $count_marker; $i++ ) {
                ...
                if ( isset( $settings->hotspot_marker[$i]->text_typography_line_height->small) && isset( $settings->hotspot_marker[$i]->text_typography_font_size->small)  && $settings->hotspot_marker[$i]->text_typography_font_size->small != 0 && !isset( $settings->hotspot_marker[$i]->text_typography_line_height_unit_responsive ) ) {
                ...
                if( isset( $settings->hotspot_marker[$i]->text_typography_line_height->medium ) && isset( $settings->hotspot_marker[$i]->text_typography_font_size->medium )  && $settings->hotspot_marker[$i]->text_typography_font_size->medium != 0 && !isset( $settings->hotspot_marker[$i]->text_typography_line_height_unit_medium ) ) {
                ...
                if( isset( $settings->hotspot_marker[$i]->text_typography_line_height->desktop) && isset( $settings->hotspot_marker[$i]->text_typography_font_size->desktop) && $settings->hotspot_marker[$i]->text_typography_font_size->desktop != 0 && !isset( $settings->hotspot_marker[$i]->text_typography_line_height_unit ) ) {
                ...
                if ( isset( $settings->hotspot_marker[$i]->tooltip_line_height->small) && isset( $settings->hotspot_marker[$i]->tooltip_font_size->small ) && $settings->hotspot_marker[$i]->tooltip_font_size->small != 0 && !isset( $settings->hotspot_marker[$i]->tooltip_line_height_unit_responsive ) ) {
                ...
                if( isset( $settings->hotspot_marker[$i]->tooltip_line_height->medium) && isset( $settings->hotspot_marker[$i]->tooltip_font_size->medium ) && $settings->hotspot_marker[$i]->tooltip_font_size->medium != 0 && !isset( $settings->hotspot_marker[$i]->tooltip_line_height_unit_medium ) ) {
                ...
                if( isset( $settings->hotspot_marker[$i]->tooltip_line_height->desktop) && isset( $settings->hotspot_marker[$i]->tooltip_font_size->desktop )&& $settings->hotspot_marker[$i]->tooltip_font_size->desktop != 0 && !isset( $settings->hotspot_marker[$i]->tooltip_line_height_unit ) ) {
		...
		public function uabb_advanced_accordion( &$settings ) {
			...
			if ( isset( $settings->content_line_height['small']) && isset( $settings->content_font_size['small'] ) && $settings->content_font_size['small'] != 0 && !isset( $settings->content_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->content_line_height['medium']) && isset( $settings->content_font_size['medium'] ) && $settings->content_font_size['medium'] != 0 && !isset( $settings->content_line_height_unit_medium )) {
			...
			if( isset( $settings->content_line_height['desktop']) && isset( $settings->content_font_size['desktop'] )  && $settings->content_font_size['desktop'] != 0 && !isset( $settings->content_line_height_unit ) ) {
		...
		public function uabb_gravity_form( &$settings ) {
            ...
            if( isset( $settings->form_title_line_height['small']) && isset( $settings->form_title_font_size['small'] ) && $settings->form_title_font_size['small'] != 0 && !isset( $settings->form_title_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->form_title_line_height['medium']) && isset( $settings->form_title_font_size['medium'] ) && $settings->form_title_font_size['medium'] != 0 && !isset( $settings->form_title_line_height_unit_medium ) ) {
			...
			if( isset( $settings->form_title_line_height['desktop']) && isset( $settings->form_title_font_size['desktop'] ) && $settings->form_title_font_size['desktop'] != 0 && !isset( $settings->form_title_line_height_unit ) ) {
            ...
            if( isset( $settings->form_desc_line_height['small']) && isset( $settings->form_desc_font_size['small'] ) && $settings->form_desc_font_size['small'] != 0 && !isset( $settings->form_desc_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->form_desc_line_height['medium']) && isset( $settings->form_desc_font_size['medium'] ) && $settings->form_desc_font_size['medium'] != 0 && !isset( $settings->form_desc_line_height_unit_medium ) ) {
			...
			if( isset( $settings->form_desc_line_height['desktop']) && isset( $settings->form_desc_font_size['desktop'] ) && $settings->form_desc_font_size['desktop'] != 0 && !isset( $settings->form_desc_line_height_unit ) ) {
            ...
            if( isset( $settings->label_line_height['small']) && isset( $settings->label_font_size['small'] ) && $settings->label_font_size['small'] != 0 && !isset( $settings->label_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->label_line_height['medium']) && isset( $settings->label_font_size['medium'] ) && $settings->label_font_size['medium'] != 0 && !isset( $settings->label_line_height_unit_medium ) ) {
			...
			if( isset( $settings->label_line_height['desktop']) && isset( $settings->label_font_size['desktop'] ) && $settings->label_font_size['desktop'] != 0 && !isset( $settings->label_line_height_unit ) ) {
		...
		public function uabb_advanced_tabs( &$settings ) {
			...
			if ( isset( $settings->title_line_height['small']) && isset( $settings->title_font_size['small']) && $settings->title_font_size['small'] != 0 &&!isset( $settings->title_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->title_line_height['medium']) && isset( $settings->title_font_size['medium']) && $settings->title_font_size['medium'] != 0 &&!isset( $settings->title_line_height_unit_medium ) ) {
			...
			if( isset( $settings->title_line_height['desktop']) && isset( $settings->title_font_size['desktop']) && $settings->title_font_size['desktop'] != 0 &&!isset( $settings->title_line_height_unit ) ) {
		...
		public function uabb_advanced_posts( &$settings ) {
			...
			if ( isset( $settings->meta_line_height['small']) && isset( $settings->meta_font_size['small'] ) && $settings->meta_font_size['small'] != 0 && !isset( $settings->meta_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->meta_line_height['medium']) && isset( $settings->meta_font_size['medium'] ) && $settings->meta_font_size['medium'] != 0 && !isset( $settings->meta_line_height_unit_medium ) ) {
			...
			if( isset( $settings->meta_line_height['desktop']) && isset( $settings->meta_font_size['desktop'] ) && $settings->meta_font_size['desktop'] != 0 && !isset( $settings->meta_line_height_unit ) ) {
		...
		public function uabb_creative_link( &$settings ) {
			...
			if ( isset( $settings->link_typography_line_height['small']) && isset( $settings->link_typography_font_size['small'] ) && $settings->link_typography_font_size['small'] != 0 && !isset( $settings->link_typography_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->link_typography_line_height['medium']) && isset( $settings->link_typography_font_size['medium'] ) && $settings->link_typography_font_size['medium'] != 0 && !isset( $settings->link_typography_line_height_unit_medium )) {
			...
			if( isset( $settings->link_typography_line_height['desktop']) && isset( $settings->link_typography_font_size['desktop'] ) && $settings->link_typography_font_size['desktop'] != 0 && !isset( $settings->link_typography_line_height_unit )) {
		...
		public function uabb_countdown( &$settings ) {
            ...
            if( isset( $settings->message_line_height['small']) && isset( $settings->message_font_size['small'] ) && $settings->message_font_size['small'] != 0 && !isset( $settings->message_line_height_unit_responsive ) ) {
            ...
            if( isset( $settings->message_line_height['medium']) && isset( $settings->message_font_size['medium'] ) && $settings->message_font_size['medium'] != 0 && !isset( $settings->message_line_height_unit_medium ) ) {
            ...
            if( isset( $settings->message_line_height['desktop']) && isset( $settings->message_font_size['desktop'] ) && $settings->message_font_size['desktop'] != 0 && !isset( $settings->message_line_height_unit ) ) {
            ...
            if( isset( $settings->digit_line_height['small']) && isset( $settings->digit_font_size['small'] ) && $settings->digit_font_size['small'] != 0 && !isset( $settings->digit_line_height_unit_responsive ) ) {
            ...
            if( isset( $settings->digit_line_height['medium']) && isset( $settings->digit_font_size['medium'] ) && $settings->digit_font_size['medium'] != 0 && !isset( $settings->digit_line_height_unit_medium ) ) {
            ...
            if( isset( $settings->digit_line_height['desktop']) && isset( $settings->digit_font_size['desktop'] ) && $settings->digit_font_size['desktop'] != 0 && !isset( $settings->digit_line_height_unit ) ) {
            ...
            if( isset( $settings->unit_line_height['small']) && isset( $settings->unit_font_size['small'] ) && $settings->unit_font_size['small'] != 0 && !isset( $settings->unit_line_height_new_responsive ) ) {
            ...
            if( isset( $settings->unit_line_height['medium']) && isset( $settings->unit_font_size['medium'] ) && $settings->unit_font_size['medium'] != 0 && !isset( $settings->unit_line_height_new_medium ) ) {
            ...
            if( isset( $settings->unit_line_height['desktop']) && isset( $settings->unit_font_size['desktop'] ) && $settings->unit_font_size['desktop'] != 0 && !isset( $settings->unit_line_height_new ) ) {
        ...
        public function uabb_dual_button( &$settings ) {
            ...
            if ( isset( $settings->_btn_one_line_height['small']) && isset( $settings->_btn_one_font_size['small'] ) && $settings->_btn_one_font_size['small'] != 0 && !isset( $settings->_btn_one_line_height_unit_responsive ) ) {
            ...
            if( isset( $settings->_btn_one_line_height['medium']) && isset( $settings->_btn_one_font_size['medium'] ) && $settings->_btn_one_font_size['medium'] != 0 && !isset( $settings->_btn_one_line_height_unit_medium ) ) {
            ...
            if( isset( $settings->_btn_one_line_height['desktop']) && isset( $settings->_btn_one_font_size['desktop'] )  && $settings->_btn_one_font_size['desktop'] != 0 && !isset( $settings->_btn_one_line_height_unit ) ) {
            ...
            if ( isset( $settings->_btn_two_line_height['small']) && isset( $settings->_btn_two_font_size['small'] )  && $settings->_btn_two_font_size['small'] != 0 && !isset( $settings->_btn_two_line_height_unit_responsive ) ) {
            ...
            if( isset( $settings->_btn_two_line_height['medium']) && isset( $settings->_btn_two_font_size['medium'] ) && $settings->_btn_two_font_size['medium'] != 0 && !isset( $settings->_btn_two_line_height_unit_medium ) ) {
            ...
            if( isset( $settings->_btn_two_line_height['desktop']) && isset( $settings->_btn_two_font_size['desktop'] ) && $settings->_btn_two_font_size['desktop'] != 0 && !isset( $settings->_btn_two_line_height_unit )  ) {
        ...
        public function uabb_dual_color_heading( &$settings ) {
            ...
            if ( isset( $settings->dual_line_height['small']) && isset( $settings->dual_font_size['small'] ) && $settings->dual_font_size['small'] != 0 && !isset( $settings->dual_line_height_unit_responsive ) ) {
            ...
            if( isset( $settings->dual_line_height['medium']) && isset( $settings->dual_font_size['medium'] ) && $settings->dual_font_size['medium'] != 0 && !isset( $settings->dual_line_height_unit_medium )) {
            ...
            if( isset( $settings->dual_line_height['desktop']) && isset( $settings->dual_font_size['desktop'] ) && $settings->dual_font_size['desktop'] != 0 && !isset( $settings->dual_line_height_unit)) {
        ...
        public function uabb_fancy_text( &$settings ) {
			...
			if ( isset( $settings->fancy_line_height['small']) && isset( $settings->fancy_font_size['small'] ) && $settings->fancy_font_size['small'] != 0 && !isset( $settings->fancy_line_height_unit_responsive )) {
			...
			if( isset( $settings->fancy_line_height['medium']) && isset( $settings->fancy_font_size['small'] ) && $settings->fancy_font_size['medium'] != 0 && !isset( $settings->fancy_line_height_unit_medium )) {
			...
			if( isset( $settings->fancy_line_height['desktop']) && isset( $settings->fancy_font_size['small'] ) && $settings->fancy_font_size['desktop'] != 0 && !isset( $settings->fancy_line_height_unit )) {
        ...
        public function uabb_flip_box( &$settings ) {
			...
			if( isset( $settings->back_title_typography_line_height['medium']) && isset( $settings->back_title_typography_font_size['small'] ) && $settings->back_title_typography_font_size['medium'] != 0 && !isset( $settings->back_title_typography_line_height_unit_medium ) ) {
			...
			if( isset( $settings->back_title_typography_line_height['desktop']) && isset( $settings->back_title_typography_font_size['small'] ) && $settings->back_title_typography_font_size['desktop'] != 0 && !isset( $settings->back_title_typography_line_height_unit ) ) {
			...
			if( isset( $settings->back_desc_typography_line_height['medium']) && isset( $settings->back_desc_typography_font_size['small'] ) && $settings->back_desc_typography_font_size['medium'] != 0 && !isset( $settings->back_desc_typography_line_height_unit_medium ) ) {
			...
			if( isset( $settings->back_desc_typography_line_height['desktop']) && isset( $settings->back_desc_typography_font_size['small'] ) && $settings->back_desc_typography_font_size['desktop'] != 0 && !isset( $settings->back_desc_typography_line_height_unit ) ) {
        ...
        public function uabb_ihover( &$settings ) {
            ...
            if ( isset( $settings->title_typography_line_height['small']) && isset( $settings->title_typography_font_size['small']) && $settings->title_typography_font_size['small'] != 0 && !isset( $settings->title_typography_line_height_unit_responsive ) ) {
            ...
            if( isset( $settings->title_typography_line_height['medium']) && isset( $settings->title_typography_font_size['medium']) && $settings->title_typography_font_size['medium'] != 0 && !isset( $settings->title_typography_line_height_unit_medium ) ) {
            ...
            if( isset( $settings->title_typography_line_height['desktop']) && isset( $settings->title_typography_font_size['desktop']) && $settings->title_typography_font_size['desktop'] != 0 && !isset( $settings->title_typography_line_height_unit ) ) {
            ...
            if ( isset( $settings->desc_typography_line_height['small']) && isset( $settings->desc_typography_font_size['small']) && $settings->desc_typography_font_size['small'] != 0 && !isset( $settings->desc_typography_line_height_unit_responsive ) ) {
            ...
            if( isset( $settings->desc_typography_line_height['medium']) && isset( $settings->desc_typography_font_size['medium']) && $settings->desc_typography_font_size['medium'] != 0 && !isset( $settings->desc_typography_line_height_unit_medium ) ) {
            ...
            if( isset( $settings->desc_typography_line_height['desktop']) && isset( $settings->desc_typography_font_size['desktop']) && $settings->desc_typography_font_size['desktop'] != 0 && !isset( $settings->desc_typography_line_height_unit ) ) {
        ...
        public function uabb_info_banner( &$settings ) {
            ...
            if ( isset( $settings->tbtn_line_height['small']) && isset( $settings->tbtn_font_size['small']) && $settings->tbtn_font_size['small'] != 0 && !isset( $settings->tbtn_line_height_unit_responsive ) ) {
            ...
            if( isset( $settings->tbtn_line_height['medium']) && isset( $settings->tbtn_font_size['medium']) && $settings->tbtn_font_size['medium'] != 0 && !isset( $settings->tbtn_line_height_unit_medium ) ) {
            ...
            if( isset( $settings->tbtn_line_height['desktop']) && isset( $settings->tbtn_font_size['desktop']) && $settings->tbtn_font_size['desktop'] != 0 && !isset( $settings->tbtn_line_height_unit ) ) {
        ...
        public function uabb_info_box( &$settings ) {	
        	...
        	if ( isset( $settings->prefix_line_height['small']) && isset( $settings->prefix_font_size['small']) && $settings->prefix_font_size['small'] != 0 && !isset( $settings->prefix_line_height_unit_responsive ) ) {
        	...
        	if( isset( $settings->prefix_line_height['medium']) && isset( $settings->prefix_font_size['medium']) && $settings->prefix_font_size['medium'] != 0 && !isset( $settings->prefix_line_height_unit_medium ) ) {
        	...
        	if( isset( $settings->prefix_line_height['desktop']) && isset( $settings->prefix_font_size['desktop']) && $settings->prefix_font_size['desktop'] != 0 && !isset( $settings->prefix_line_height_unit ) ) {
        	...
        	if ( isset( $settings->subhead_line_height['small']) && isset( $settings->subhead_font_size['small']) && $settings->subhead_font_size['small'] != 0 && !isset( $settings->subhead_line_height_unit_responsive ) ) {
        	...
        	if( isset( $settings->subhead_line_height['medium']) && isset( $settings->subhead_font_size['medium']) && $settings->subhead_font_size['medium'] != 0 && !isset( $settings->subhead_line_height_unit_medium ) ) {
        	...
        	if( isset( $settings->subhead_line_height['desktop']) && isset( $settings->subhead_font_size['desktop']) && $settings->subhead_font_size['desktop'] != 0 && !isset( $settings->subhead_line_height_unit ) ) {
        ...
        public function uabb_info_circle( &$settings ) {	
			...
			if ( isset( $settings->desc_line_height) && isset( $settings->desc_font_size['small']) && $settings->desc_font_size['small'] != 0 && !isset( $settings->desc_line_height_unit_responsive ) ) {
			    if( is_numeric( $settings->desc_line_height['small']) && is_numeric( $settings->desc_font_size['small']) )
			    $settings->desc_line_height_unit_responsive = round( $settings->desc_line_height['small'] / $settings->desc_font_size['small'], 2 );
			}
			if( isset( $settings->desc_line_height['medium']) && isset( $settings->desc_font_size['medium']) && $settings->desc_font_size['medium'] != 0 && !isset( $settings->desc_line_height_unit_medium ) ) {
			...
			for( $i = 0; $i < count( $settings->add_circle_item ); $i++ ) {
                ...
                if ( isset( $settings->add_circle_item[$i]->btn_line_height->small) && isset( $settings->add_circle_item[$i]->btn_font_size->small) && $settings->add_circle_item[$i]->btn_font_size->small != 0 && !isset( $settings->add_circle_item[$i]->btn_line_height_unit_responsive ) ) {
                ...
                if ( isset( $settings->add_circle_item[$i]->btn_line_height->medium) && isset( $settings->add_circle_item[$i]->btn_font_size->medium) && $settings->add_circle_item[$i]->btn_font_size->medium != 0 && !isset( $settings->add_circle_item[$i]->btn_line_height_unit_medium ) ) {
                ...
                if ( isset( $settings->add_circle_item[$i]->btn_line_height->desktop) && isset( $settings->add_circle_item[$i]->btn_font_size->desktop) && $settings->add_circle_item[$i]->btn_font_size->desktop != 0 && !isset( $settings->add_circle_item[$i]->btn_line_height_unit ) ) {
        ...
        public function uabb_list_icon( &$settings ) {	
            ...
            if( isset( $settings->typography_line_height['small']) && isset( $settings->typography_font_size['small'] ) && $settings->typography_font_size['small'] != 0 && !isset( $settings->typography_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->typography_line_height['medium']) && isset( $settings->typography_font_size['medium'] ) && $settings->typography_font_size['medium'] != 0 && !isset( $settings->typography_line_height_unit_medium ) ) {
			...
			if( isset( $settings->typography_line_height['desktop']) && isset( $settings->typography_font_size['desktop'] ) && $settings->typography_font_size['desktop'] != 0 && !isset( $settings->typography_line_height_unit ) ) {
        ...
        public function uabb_mailchimp_subscribe_form( &$settings ) {	
            ...
            if( isset( $settings->subheading_line_height['small']) && isset( $settings->subheading_font_size['small'] ) && $settings->subheading_font_size['small'] != 0 && !isset( $settings->subheading_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->subheading_line_height['medium']) && isset( $settings->subheading_font_size['medium'] ) && $settings->subheading_font_size['medium'] != 0 && !isset( $settings->subheading_line_height_unit_medium ) ) {
			...
			if( isset( $settings->subheading_line_height['desktop']) && isset( $settings->subheading_font_size['desktop'] ) && $settings->subheading_font_size['desktop'] != 0 && !isset( $settings->subheading_line_height_unit ) ) {
            ...
            if( isset( $settings->input_line_height['small']) && isset( $settings->input_font_size['small'] ) && $settings->input_font_size['small'] != 0 && !isset( $settings->input_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->input_line_height['medium']) && isset( $settings->input_font_size['medium'] ) && $settings->input_font_size['medium'] != 0 && !isset( $settings->input_line_height_unit_medium ) ) {
			...
			if( isset( $settings->input_line_height['desktop']) && isset( $settings->input_font_size['desktop'] ) && $settings->input_font_size['desktop'] != 0 && !isset( $settings->input_line_height_unit ) ) {
        ...
        public function uabb_modal_popup( &$settings ) {	
			...
			if( isset( $settings->ct_content_line_height['small']) && isset( $settings->ct_content_font_size['small'] ) && $settings->ct_content_font_size['small'] != 0 && !isset( $settings->ct_content_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->ct_content_line_height['medium']) && isset( $settings->ct_content_font_size['medium'] ) && $settings->ct_content_font_size['medium'] != 0 && !isset( $settings->ct_content_line_height_unit_medium ) ) {
			...
			if( isset( $settings->ct_content_line_height['desktop']) && isset( $settings->ct_content_font_size['desktop'] ) && $settings->ct_content_font_size['desktop'] != 0 && !isset( $settings->ct_content_line_height_unit ) ) {
        ...
        public function uabb_pricing_box( &$settings ) {	
			...
			if( isset( $settings->price_typography_line_height['small']) && isset( $settings->price_typography_font_size['small'] ) && $settings->price_typography_font_size['small'] != 0 && !isset( $settings->price_typography_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->price_typography_line_height['medium']) && isset( $settings->price_typography_font_size['medium'] ) && $settings->price_typography_font_size['medium'] != 0 && !isset( $settings->price_typography_line_height_unit_medium ) ) {
			...
			if( isset( $settings->price_typography_line_height['desktop']) && isset( $settings->price_typography_font_size['desktop'] ) && $settings->price_typography_font_size['desktop'] != 0 && !isset( $settings->price_typography_line_height_unit ) ) {
            ...
            if( isset( $settings->duration_typography_line_height['small']) && isset( $settings->duration_typography_font_size['small'] ) && $settings->duration_typography_font_size['small'] != 0 && !isset( $settings->duration_typography_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->duration_typography_line_height['medium']) && isset( $settings->duration_typography_font_size['medium'] ) && $settings->duration_typography_font_size['medium'] != 0 && !isset( $settings->duration_typography_line_height_unit_medium ) ) {
			...
			if( isset( $settings->duration_typography_line_height['desktop']) && isset( $settings->duration_typography_font_size['desktop'] ) && $settings->duration_typography_font_size['desktop'] != 0 && !isset( $settings->duration_typography_line_height_unit ) ) {
            ...
            if( isset( $settings->feature_typography_line_height['small']) && isset( $settings->feature_typography_font_size['small'] ) && $settings->feature_typography_font_size['small'] != 0 && !isset( $settings->feature_typography_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->feature_typography_line_height['medium']) && isset( $settings->feature_typography_font_size['medium'] ) && $settings->feature_typography_font_size['medium'] != 0 && !isset( $settings->feature_typography_line_height_unit_medium ) ) {
			...
			if( isset( $settings->feature_typography_line_height['desktop']) && isset( $settings->feature_typography_font_size['desktop'] ) && $settings->feature_typography_font_size['desktop'] != 0 && !isset( $settings->feature_typography_line_height_unit ) ) {
            ...
            for( $i = 0; $i < count( $settings->pricing_columns ); $i++ ) {
        	    ...
        	    if( isset( $settings->pricing_columns[$i]->button_typography_line_height->small) && isset( $settings->pricing_columns[$i]->button_typography_font_size->small ) && $settings->pricing_columns[$i]->button_typography_font_size->small != 0 && !isset( $settings->pricing_columns[$i]->button_typography_line_height_unit_responsive ) ) {
				...
				if( isset( $settings->pricing_columns[$i]->button_typography_line_height->medium) && isset( $settings->pricing_columns[$i]->button_typography_font_size->medium ) && $settings->pricing_columns[$i]->button_typography_font_size->medium != 0 && !isset(  $settings->pricing_columns[$i]->button_typography_line_height_unit_medium ) ) {
        	    ...
        	    if( isset( $settings->pricing_columns[$i]->featured_line_height->small) && isset( $settings->pricing_columns[$i]->featured_font_size->small ) && $settings->pricing_columns[$i]->featured_font_size->small != 0 && !isset( $settings->pricing_columns[$i]->featured_line_height_unit_responsive ) ) {
				...
				if( isset( $settings->pricing_columns[$i]->featured_line_height->medium) && isset( $settings->pricing_columns[$i]->featured_font_size->medium ) && $settings->pricing_columns[$i]->featured_font_size->medium != 0 && !isset(  $settings->pricing_columns[$i]->featured_line_height_unit_medium ) ) {
				...
				if( isset( $settings->pricing_columns[$i]->featured_line_height->desktop ) && isset( $settings->pricing_columns[$i]->featured_font_size->desktop ) && $settings->pricing_columns[$i]->featured_font_size->desktop != 0 && !isset( $settings->pricing_columns[$i]->featured_line_height_unit ) ) {
		...
		public function uabb_beforeafterslider( &$settings ) {
            ...
            if( isset( $settings->slider_line_height['small']) && isset( $settings->slider_font_size['small'] ) && $settings->slider_font_size['small'] != 0 && !isset( $settings->slider_line_height_unit_responsive ) ) {
            ...
            if( isset( $settings->slider_line_height['medium']) && isset( $settings->slider_font_size['medium'] ) && $settings->slider_font_size['medium'] != 0 && !isset( $settings->slider_line_height_unit_medium ) ) {
            ...
            if( isset( $settings->slider_line_height['desktop']) && isset( $settings->slider_font_size['desktop'] ) && $settings->slider_font_size['desktop'] != 0 && !isset( $settings->slider_line_height_unit ) ) {
		...
		public function team( &$settings ) {
            ...
            if( isset( $settings->desg_line_height['small']) && isset( $settings->desg_font_size['small'] ) && $settings->desg_font_size['small'] != 0 && !isset( $settings->desg_line_height_unit_responsive ) ) {
			...
			if( isset( $settings->desg_line_height['medium']) && isset( $settings->desg_font_size['medium'] ) && $settings->desg_font_size['medium'] != 0 && !isset( $settings->desg_line_height_unit_medium ) ) {
			...
			if( isset( $settings->desg_line_height['desktop']) && isset( $settings->desg_font_size['desktop'] ) && $settings->desg_font_size['desktop'] != 0 && !isset( $settings->desg_line_height_unit ) ) {
		...
		public function progress_bar( &$settings ) {
            ...
            if( isset( $settings->before_after_line_height['small']) && isset( $settings->before_after_font_size['small'] ) && $settings->before_after_font_size['small'] != 0 && !isset( $settings->before_after_line_height_unit_responsive ) ) {
            ...
            if( isset( $settings->before_after_line_height['medium']) && isset( $settings->before_after_font_size['medium'] ) && $settings->before_after_font_size['medium'] != 0 && !isset( $settings->before_after_line_height_unit_medium ) ) {
            ...
            if( isset( $settings->before_after_line_height['desktop']) && isset( $settings->before_after_font_size['desktop'] ) && $settings->before_after_font_size['desktop'] != 0 && !isset( $settings->before_after_line_height_unit ) ) {
            ...
            if( isset( $settings->number_line_height['small']) && isset( $settings->number_font_size['small'] ) && $settings->number_font_size['small'] != 0 && !isset( $settings->number_line_height_unit_responsive ) ) {
            ...
            if( isset( $settings->number_line_height['medium']) && isset( $settings->number_font_size['medium'] ) && $settings->number_font_size['medium'] != 0 && !isset( $settings->number_line_height_unit_medium ) ) {
            ...
            if( isset( $settings->number_line_height['desktop']) && isset( $settings->number_font_size['desktop'] ) && $settings->number_font_size['desktop'] != 0 && !isset( $settings->number_line_height_unit ) ) {
