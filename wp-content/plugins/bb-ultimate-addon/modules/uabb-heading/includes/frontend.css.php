...
.fl-node-<?php echo $id; ?> <?php /* echo $settings->tag; */?>.uabb-heading * {
	...
	<?php if( isset( $settings->font_size_unit ) && $settings->font_size_unit == '' && isset( $settings->new_font_size['desktop'] ) && $settings->new_font_size['desktop'] != '' ) { ?>
...
<?php if($global_settings->responsive_enabled) { ?> 
        ...
        @media ( max-width: <?php echo $global_settings->medium_breakpoint .'px'; ?> ) {
            ...
            .fl-node-<?php echo $id; ?> <?php /* echo $settings->tag; */?>.uabb-heading * { 
				...
				<?php if( isset( $settings->font_size_unit_medium ) && $settings->font_size_unit_medium == '' && isset( $settings->new_font_size['medium'] ) && $settings->new_font_size['medium'] != '' ) { ?>
        ...
        @media ( max-width: <?php echo $global_settings->responsive_breakpoint .'px'; ?> ) {
            ...
            .fl-node-<?php echo $id; ?> <?php /* echo $settings->tag; */?>.uabb-heading * {
           		...
           		<?php if( isset( $settings->font_size_unit_responsive ) && $settings->font_size_unit_responsive == '' && isset( $settings->new_font_size['small'] ) && $settings->new_font_size['small'] != '' ) { ?>
