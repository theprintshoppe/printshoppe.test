...
if ( $settings->_btn_one_font_family['family'] != "Default" || isset($settings->_btn_one_font_size['desktop']) || isset($settings->_btn_one_line_height['desktop'])  || isset($settings->_btn_one_font_size_unit) || isset($settings->_btn_one_line_height_unit) ) { ?>
	.fl-node-<?php echo $id;?> .uabb-btn.uabb-btn-one {
		<?php if( $settings->_btn_one_font_family['family'] != "Default") : ?>
			<?php UABB_Helper::uabb_font_css( $settings->_btn_one_font_family ); ?>
		<?php endif; ?>

			<?php if( isset( $settings->_btn_one_font_size_unit ) && $settings->_btn_one_font_size_unit == '' && isset( $settings->_btn_one_font_size['desktop'] ) && $settings->_btn_one_font_size['desktop'] != '' ) { ?>
				font-size: <?php echo $settings->_btn_one_font_size['desktop']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->_btn_one_font_size_unit ) && $settings->_btn_one_font_size_unit != '' ) : ?>
			...
			<?php if( isset( $settings->_btn_one_line_height_unit ) && $settings->_btn_one_line_height_unit == '' && isset( $settings->_btn_one_line_height['desktop'] ) && $settings->_btn_one_line_height['desktop'] != '' ) { ?>
				line-height: <?php echo $settings->_btn_one_line_height['desktop']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->_btn_one_line_height_unit ) && $settings->_btn_one_line_height_unit != '' ) : ?>
...
<?php
if ( $settings->_btn_two_font_family['family'] != "Default" || isset($settings->_btn_two_font_size['desktop']) || isset($settings->_btn_two_line_height['desktop'])  || isset( $settings->_btn_two_font_size_unit ) || isset( $settings->_btn_two_line_height_unit ) ) { ?>
	.fl-node-<?php echo $id;?> .uabb-btn.uabb-btn-two {
		...
		<?php if( isset( $settings->_btn_two_font_size_unit ) && $settings->_btn_two_font_size_unit == '' && isset( $settings->_btn_two_font_size['desktop'] ) && $settings->_btn_two_font_size['desktop'] != '' ) { ?>
			font-size: <?php echo $settings->_btn_two_font_size['desktop']; ?>px;
		<?php } else { ?>
			<?php if( isset( $settings->_btn_two_font_size_unit ) && $settings->_btn_two_font_size_unit != '' ) : ?>
		...
		<?php if( isset( $settings->_btn_two_line_height_unit ) && $settings->_btn_two_line_height_unit == '' && isset( $settings->_btn_two_line_height['desktop'] ) && $settings->_btn_two_line_height['desktop'] != '' ) { ?>
			line-height: <?php echo $settings->_btn_two_line_height['desktop']; ?>px;
		<?php } else { ?>
			<?php if( isset( $settings->_btn_two_line_height_unit ) && $settings->_btn_two_line_height_unit != '' ) : ?>
		...
		@media ( max-width: <?php echo $global_settings->medium_breakpoint .'px'; ?> ) {
			...
			<?php if( isset( $settings->_btn_one_font_size['medium'] ) && $settings->_btn_one_font_size['medium'] !="" || isset( $settings->_btn_one_line_height['medium'] ) && $settings->_btn_one_line_height['medium'] != "" ||  isset( $settings->_btn_one_font_size_unit_medium ) || isset( $settings->_btn_one_line_height_unit_medium ) || isset( $settings->_btn_one_line_height_unit ) ) { ?>
				.fl-node-<?php echo $id;?> .uabb-btn.uabb-btn-one {
					...
					<?php if( isset( $settings->_btn_one_font_size_unit_medium ) && $settings->_btn_one_font_size_unit_medium == '' && isset( $settings->_btn_one_font_size['medium'] ) && $settings->_btn_one_font_size['medium'] != '' ) { ?>
							font-size: <?php echo $settings->_btn_one_font_size['medium']; ?>px;
					<?php } else { ?>
						<?php if( isset( $settings->_btn_one_font_size_unit_medium ) && $settings->_btn_one_font_size_unit_medium != '' ) : ?>
			    	...
			    	<?php if( isset( $settings->_btn_one_line_height_unit_medium ) && $settings->_btn_one_line_height_unit_medium == '' && isset( $settings->_btn_one_line_height['medium'] ) && $settings->_btn_one_line_height['medium'] != '' ) { ?>
			    		line-height: <?php echo $settings->_btn_one_line_height['medium']; ?>px;
			    	<?php } else { ?>
						<?php if( isset( $settings->_btn_one_line_height_unit_medium ) && $settings->_btn_one_line_height_unit_medium != '' ) : ?>
			...
			<?php if( isset( $settings->_btn_two_font_size['medium'] ) && $settings->_btn_two_font_size['medium'] !="" || isset( $settings->_btn_two_line_height['medium'] )  || isset( $settings->_btn_two_font_size_unit_medium) || isset( $settings->_btn_two_line_height_unit_medium ) || isset( $settings->_btn_two_line_height_unit ) ) { ?>
				.fl-node-<?php echo $id;?> .uabb-btn.uabb-btn-two {
                    ...
                    <?php if( isset( $settings->_btn_two_font_size_unit_medium ) && $settings->_btn_two_font_size_unit_medium == '' && isset( $settings->_btn_two_font_size['medium'] ) && $settings->_btn_two_font_size['medium'] != '' ) { ?>
                    		font-size: <?php echo $settings->_btn_two_font_size['medium']; ?>px;
                    <?php } else { ?>
						<?php if( isset( $settings->_btn_two_font_size_unit_medium ) && $settings->_btn_two_font_size_unit_medium != '' ) : ?>
					...
					<?php if( isset( $settings->_btn_two_line_height_unit_medium ) && $settings->_btn_two_line_height_unit_medium == '' && isset( $settings->_btn_two_line_height['medium'] ) && $settings->_btn_two_line_height['medium'] != '' ) { ?>
						line-height: <?php echo $settings->_btn_two_line_height['medium']; ?>px;
					<?php } else { ?>
						<?php if( isset( $settings->_btn_two_line_height_unit_medium ) && $settings->_btn_two_line_height_unit_medium != '' ) : ?>
		...
		@media ( max-width: <?php echo $global_settings->responsive_breakpoint .'px'; ?> ) {
			...
			<?php if( isset( $settings->_btn_one_font_size['small'] ) || isset( $settings->_btn_one_line_height['small'] ) || isset( $settings->_btn_one_font_size_unit_responsive ) || isset( $settings->_btn_one_line_height_unit_responsive )  || isset( $settings->_btn_one_line_height_unit_medium ) || isset( $settings->_btn_one_line_height_unit )  ) { ?>
				.fl-node-<?php echo $id;?> .uabb-btn.uabb-btn-one {
					...
					<?php if( isset( $settings->_btn_one_font_size_unit_responsive ) && $settings->_btn_one_font_size_unit_responsive == '' && isset( $settings->_btn_one_font_size['small'] ) && $settings->_btn_one_font_size['small'] != '' ) { ?>
							font-size: <?php echo $settings->_btn_one_font_size['small']; ?>px;
					<?php } else { ?>
						<?php if( isset( $settings->_btn_one_font_size_unit_responsive ) && $settings->_btn_one_font_size_unit_responsive != '' ) : ?>
					...
					<?php if( isset( $settings->_btn_one_line_height_unit_responsive ) && $settings->_btn_one_line_height_unit_responsive == '' && isset( $settings->_btn_one_line_height['small'] ) && $settings->_btn_one_line_height['small'] != '' ) { ?>
						line-height: <?php echo $settings->_btn_one_line_height['small']; ?>px;
					<?php } else { ?>
						<?php if( isset( $settings->_btn_one_line_height_unit_responsive ) && $settings->_btn_one_line_height_unit_responsive != '' ) : ?>
			...
			<?php if( isset( $settings->_btn_two_font_size['small'] ) || isset( $settings->_btn_two_line_height['small'] ) || isset( $settings->_btn_two_font_size_unit_responsive ) || isset( $settings->_btn_two_line_height_unit_responsive ) || isset( $settings->_btn_two_line_height_unit_medium ) || isset( $settings->_btn_two_line_height_unit ) ) { ?>
				.fl-node-<?php echo $id;?> .uabb-btn.uabb-btn-two {
                    ...
                    <?php if( isset( $settings->_btn_two_font_size_unit_responsive ) && $settings->_btn_two_font_size_unit_responsive == '' && isset( $settings->_btn_two_font_size['small'] ) && $settings->_btn_two_font_size['small'] != '' ) { ?>
                    		font-size: <?php echo $settings->_btn_two_font_size['small']; ?>px;
                    <?php } else { ?>
						<?php if( isset( $settings->_btn_two_font_size_unit_responsive ) && $settings->_btn_two_font_size_unit_responsive != '' ) : ?>
                    ...
                    <?php if( isset( $settings->_btn_two_line_height_unit_responsive ) && $settings->_btn_two_line_height_unit_responsive == '' && isset( $settings->_btn_two_line_height['small'] ) && $settings->_btn_two_line_height['small'] != '' ) { ?>
                    	line-height: <?php echo $settings->_btn_two_line_height['small']; ?>px;
                    <?php } else { ?>
						<?php if( isset( $settings->_btn_two_line_height_unit_responsive ) && $settings->_btn_two_line_height_unit_responsive != '' ) : ?>
