	...
	?>
		@media ( max-width: <?php echo $global_settings->medium_breakpoint .'px'; ?> ) {
			.fl-node-<?php echo $id;?> .uabb-info-list-content .uabb-info-list-title {
				...
				<?php } else if( isset( $settings->heading_font_size_unit_medium ) && $settings->heading_font_size_unit_medium == '' && isset( $settings->new_heading_font_size['medium'] ) && $settings->new_heading_font_size['medium'] != '' ) { ?> 
					font-size: <?php echo $settings->new_heading_font_size['medium']; ?>px;
				<?php } ?>
