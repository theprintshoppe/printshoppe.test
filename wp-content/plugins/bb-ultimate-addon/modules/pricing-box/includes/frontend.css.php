	...
	$pricing_column = $settings->pricing_columns[$i];
		...
		if( $settings->pricing_columns[$i]->set_featured == 'yes' ) {
			...
			.fl-builder-content .fl-node-<?php echo $id; ?> .uabb-pricing-table-column-<?php echo $i+1; ?> .uabb-featured-pricing-box {
				...
				<?php if( isset( $settings->pricing_columns[$i]->featured_font_size_unit ) && $settings->pricing_columns[$i]->featured_font_size_unit == '' && isset( $settings->pricing_columns[$i]->featured_font_size->desktop ) && $settings->pricing_columns[$i]->featured_font_size->desktop != '' ) { ?>
					font-size: <?php echo $settings->pricing_columns[$i]->featured_font_size->desktop; ?>px;
				<?php } else { ?>
					<?php if( isset( $settings->pricing_columns[$i]->featured_font_size_unit ) && $settings->pricing_columns[$i]->featured_font_size_unit != '' ) : ?>
				...
				<?php if( isset( $settings->pricing_columns[$i]->featured_line_height_unit ) && $settings->pricing_columns[$i]->featured_line_height_unit == '' && isset( $settings->pricing_columns[$i]->featured_line_height->desktop ) && $settings->pricing_columns[$i]->featured_line_height->desktop != '' ) { ?>
					line-height: <?php echo $settings->pricing_columns[$i]->featured_line_height->desktop; ?>px;
				<?php } else { ?>
			...
			?>
			    @media ( max-width: <?php echo $global_settings->medium_breakpoint; ?>px ) {
			        ...
			        <?php if( isset( $settings->pricing_columns[$i]->featured_font_size_unit_medium ) && $settings->pricing_columns[$i]->featured_font_size_unit_medium == '' && isset( $settings->pricing_columns[$i]->featured_font_size->medium ) && $settings->pricing_columns[$i]->featured_font_size->medium != '' ) { ?>
			        	font-size: <?php echo $settings->pricing_columns[$i]->featured_font_size->medium; ?>px;
			        <?php } else { ?>
						<?php if( isset( $settings->pricing_columns[$i]->featured_font_size_unit_medium ) && $settings->pricing_columns[$i]->featured_font_size_unit_medium != '' ) : ?>
					...
					<?php if( isset( $settings->pricing_columns[$i]->featured_line_height_unit_medium ) && $settings->pricing_columns[$i]->featured_line_height_unit_medium == '' && isset( $settings->pricing_columns[$i]->featured_line_height->medium ) && $settings->pricing_columns[$i]->featured_line_height->medium != '' ) { ?>
						line-height: <?php echo $settings->pricing_columns[$i]->featured_line_height->medium; ?>px;
					<?php } else { ?>
			     ...
			     @media ( max-width: <?php echo $global_settings->responsive_breakpoint; ?>px ) {
			        .fl-builder-content .fl-node-<?php echo $id; ?> .uabb-pricing-table-column-<?php echo $i+1; ?> .uabb-featured-pricing-box {
			            ...
			            <?php if( isset( $settings->pricing_columns[$i]->featured_font_size_unit_responsive ) && $settings->pricing_columns[$i]->featured_font_size_unit_responsive == '' && isset( $settings->pricing_columns[$i]->featured_font_size->small ) && $settings->pricing_columns[$i]->featured_font_size->small != '' ) { ?>
			            ...
			            <?php if( isset( $settings->pricing_columns[$i]->featured_line_height_unit_responsive ) && $settings->pricing_columns[$i]->featured_line_height_unit_responsive == '' && isset( $settings->pricing_columns[$i]->featured_line_height->small ) && $settings->pricing_columns[$i]->featured_line_height->small != '' ) { ?>
			            	line-height: <?php echo $settings->pricing_columns[$i]->featured_line_height->small; ?>px;
			            <?php } else { ?>
...
.fl-builder-content .fl-node-<?php echo $id; ?> .uabb-pricing-table-column .uabb-pricing-table-price {
	...
	<?php if( isset( $settings->price_typography_font_size_unit ) && $settings->price_typography_font_size_unit == '' && isset( $settings->price_typography_font_size['desktop'] ) && $settings->price_typography_font_size['desktop'] != '' ) { ?>
		font-size: <?php echo $settings->price_typography_font_size['desktop']; ?>px;
	<?php } else { ?>
		<?php if( isset( $settings->price_typography_font_size_unit ) && $settings->price_typography_font_size_unit != '' ) : ?>
	...
	<?php if( isset( $settings->price_typography_line_height_unit ) && $settings->price_typography_line_height_unit == '' && isset( $settings->price_typography_line_height['desktop'] ) && $settings->price_typography_line_height['desktop'] != '' ) { ?>
		line-height: <?php echo $settings->price_typography_line_height['desktop']; ?>px;
	<?php } else { ?>
...
.fl-node-<?php echo $id; ?> .uabb-pricing-table .uabb-pricing-table-duration {
    ...
    <?php if( isset( $settings->duration_typography_font_size_unit ) && $settings->duration_typography_font_size_unit == '' && isset( $settings->duration_typography_font_size['desktop'] ) && $settings->duration_typography_font_size['desktop'] != '' ) { ?>
    	font-size: <?php echo $settings->duration_typography_font_size['desktop']; ?>px;
    <?php } else { ?>
		<?php if( isset( $settings->duration_typography_font_size_unit ) && $settings->duration_typography_font_size_unit != '' ) : ?>
	...
	<?php if( isset( $settings->duration_typography_line_height_unit ) && $settings->duration_typography_line_height_unit == '' && isset( $settings->duration_typography_line_height['desktop'] ) && $settings->duration_typography_line_height['desktop'] != '' ) { ?>
		line-height: <?php echo $settings->duration_typography_line_height['desktop']; ?>px;
	<?php } else { ?>
		<?php if( isset( $settings->duration_typography_line_height_unit ) && $settings->duration_typography_line_height_unit != '' ) : ?>
...
.fl-node-<?php echo $id; ?> .uabb-pricing-table li {
	...
	<?php if( isset( $settings->feature_typography_font_size_unit ) && $settings->feature_typography_font_size_unit == '' && isset( $settings->feature_typography_font_size['desktop'] ) && $settings->feature_typography_font_size['desktop'] != '' ) { ?>
		font-size: <?php echo $settings->feature_typography_font_size['desktop']; ?>px;
	<?php } else { ?>
		<?php if( isset( $settings->feature_typography_font_size_unit ) && $settings->feature_typography_font_size_unit != '' ) : ?>
	...
	<?php if( isset( $settings->feature_typography_line_height_unit ) && $settings->feature_typography_line_height_unit == '' && isset( $settings->feature_typography_line_height['desktop'] ) && $settings->feature_typography_line_height['desktop'] != '' ) { ?>
		line-height: <?php echo $settings->feature_typography_line_height['desktop']; ?>px;
	<?php } else { ?>
		<?php if( isset( $settings->feature_typography_line_height_unit ) && $settings->feature_typography_line_height_unit != '' ) : ?>
...
if( $settings->add_legend == 'yes' ) { ?>
	...
	.fl-node-<?php echo $id; ?> .uabb-pricing-table .uabb-pricing-table-column .uabb-pricing-table-features .uabb-pricing-ledgend {
		...
		<?php if( isset( $settings->legend_column->legend_font_size_unit ) && $settings->legend_column->legend_font_size_unit == '' && isset( $settings->legend_column->legend_font_size->desktop ) && $settings->legend_column->legend_font_size->desktop != '' ) { ?>
			font-size: <?php echo $settings->legend_column->legend_font_size->desktop; ?>px;
		<?php } else { ?>
			<?php if( isset( $settings->legend_column->legend_font_size_unit ) && $settings->legend_column->legend_font_size_unit != '' ) : ?>
		...
		<?php if( isset( $settings->legend_column->legend_line_height_unit ) && $settings->legend_column->legend_line_height_unit == '' && isset( $settings->legend_column->legend_line_height->desktop ) && $settings->legend_column->legend_line_height->desktop != '' ) { ?>
			line-height: <?php echo $settings->legend_column->legend_line_height->desktop; ?>px;
		<?php } else { ?>
			<?php if( isset( $settings->legend_column->legend_line_height_unit ) && $settings->legend_column->legend_line_height_unit != '' ) : ?>
...
<?php if( $global_settings->responsive_enabled ) { // Responsive Typography ?>
	@media ( max-width: <?php echo $global_settings->medium_breakpoint; ?>px ) {
		...
		.fl-builder-content .fl-node-<?php echo $id; ?> .uabb-pricing-table-column .uabb-pricing-table-price {
			...
			<?php if( isset( $settings->title_typography_font_size_unit_medium ) && $settings->title_typography_font_size_unit_medium == '' && isset( $settings->title_typography_font_size['medium'] ) && $settings->title_typography_font_size['medium'] != '' ) { ?>
				font-size: <?php echo $settings->title_typography_font_size['medium']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->price_typography_font_size_unit_medium ) && $settings->price_typography_font_size_unit_medium != '' ) : ?>
					font-size: <?php echo $settings->price_typography_font_size_unit_medium; ?>px;
				<?php endif; ?>
			<?php } ?>
			...
			<?php if( isset( $settings->price_typography_line_height_unit_medium ) && $settings->price_typography_line_height_unit_medium == '' && isset( $settings->price_typography_line_height['medium'] ) && $settings->price_typography_line_height['medium'] != '' ) { ?>
				line-height: <?php echo $settings->price_typography_line_height['medium']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->price_typography_line_height_unit_medium ) && $settings->price_typography_line_height_unit_medium != '' ) : ?>
		...
		.fl-node-<?php echo $id; ?> .uabb-pricing-table .uabb-pricing-table-duration {
			...
			<?php if( isset( $settings->duration_typography_font_size_unit_medium ) && $settings->duration_typography_font_size_unit_medium == '' && isset( $settings->duration_typography_font_size['medium'] ) && $settings->duration_typography_font_size['medium'] != '' ) { ?>
				font-size: <?php echo $settings->duration_typography_font_size['medium']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->duration_typography_font_size_unit_medium ) && $settings->duration_typography_font_size_unit_medium != '' ) : ?>
			...
			<?php if( isset( $settings->duration_typography_line_height_unit_medium ) && $settings->duration_typography_line_height_unit_medium == '' && isset( $settings->duration_typography_line_height['medium'] ) && $settings->duration_typography_line_height['medium'] != '' ) { ?>
				line-height: <?php echo $settings->duration_typography_line_height['medium']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->duration_typography_line_height_unit_medium ) && $settings->duration_typography_line_height_unit_medium != '' ) : ?>
		...
		.fl-node-<?php echo $id; ?> .uabb-pricing-table li {
			...
			<?php if( isset( $settings->feature_typography_font_size_unit_medium ) && $settings->feature_typography_font_size_unit_medium == '' && isset( $settings->feature_typography_font_size['medium'] ) && $settings->feature_typography_font_size['medium'] != '' ) { ?>
				font-size: <?php echo $settings->feature_typography_font_size['medium']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->feature_typography_font_size_unit_medium ) && $settings->feature_typography_font_size_unit_medium != '' ) : ?>
			...
			<?php if( isset( $settings->feature_typography_line_height_unit_medium ) && $settings->feature_typography_line_height_unit_medium == '' && isset( $settings->feature_typography_line_height['medium'] ) && $settings->feature_typography_line_height['medium'] != '' ) { ?>
				line-height: <?php echo $settings->feature_typography_line_height['medium']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->feature_typography_line_height_unit_medium ) && $settings->feature_typography_line_height_unit_medium != '' ) : ?>
		...
		<?php if( $settings->add_legend == 'yes' ) { ?>
			...
			.fl-node-<?php echo $id; ?> .uabb-pricing-table .uabb-pricing-table-column .uabb-pricing-table-features .uabb-pricing-ledgend {
				...
				<?php if( isset( $settings->legend_column->legend_font_size_unit_medium ) && $settings->legend_column->legend_font_size_unit_medium == '' && isset( $settings->legend_column->legend_font_size->medium ) && $settings->legend_column->legend_font_size->medium != '' ) { ?>
					font-size: <?php echo $settings->legend_column->legend_font_size->medium; ?>px;
				<?php } else { ?>
					<?php if( isset( $settings->legend_column->legend_font_size_unit_medium ) && $settings->legend_column->legend_font_size_unit_medium != '' ) : ?>
				...
				<?php if( isset( $settings->legend_column->legend_line_height_unit_medium ) && $settings->legend_column->legend_line_height_unit_medium == '' && isset( $settings->legend_column->legend_line_height->medium ) && $settings->legend_column->legend_line_height->medium != '' ) { ?>
					line-height: <?php echo $settings->legend_column->legend_line_height->medium; ?>px;
				<?php } else { ?>
					<?php if( isset( $settings->legend_column->legend_line_height_unit_medium ) && $settings->legend_column->legend_line_height_unit_medium != '' ) : ?>
	...
	@media ( max-width: <?php echo $global_settings->responsive_breakpoint; ?>px ) {
		...
		.fl-builder-content .fl-node-<?php echo $id; ?> .uabb-pricing-table-column .uabb-pricing-table-price {
			...
			<?php if( isset( $settings->price_typography_font_size_unit_responsive ) && $settings->price_typography_font_size_unit_responsive == '' && isset( $settings->price_typography_font_size['small'] ) && $settings->price_typography_font_size['small'] != '' ) { ?>
				font-size: <?php echo $settings->price_typography_font_size['small']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->price_typography_font_size_unit_responsive ) && $settings->price_typography_font_size_unit_responsive != '' ) : ?>
			...
			<?php if( isset( $settings->price_typography_line_height_unit_responsive ) && $settings->price_typography_line_height_unit_responsive == '' && isset( $settings->price_typography_line_height['small'] ) && $settings->price_typography_line_height['small'] != '' ) { ?>
				line-height: <?php echo $settings->price_typography_line_height['small']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->price_typography_line_height_unit_responsive ) && $settings->price_typography_line_height_unit_responsive != '' ) : ?>
		...
		.fl-node-<?php echo $id; ?> .uabb-pricing-table .uabb-pricing-table-duration {
			...
			<?php if( isset( $settings->duration_typography_font_size_unit_responsive ) && $settings->duration_typography_font_size_unit_responsive == '' && isset( $settings->duration_typography_font_size['small'] ) && $settings->duration_typography_font_size['small'] != '' ) { ?>
				font-size: <?php echo $settings->duration_typography_font_size['small']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->duration_typography_font_size_unit_responsive ) && $settings->duration_typography_font_size_unit_responsive != '' ) : ?>
			...
			<?php if( isset( $settings->duration_typography_line_height_unit_responsive ) && $settings->duration_typography_line_height_unit_responsive == '' && isset( $settings->duration_typography_line_height['small'] ) && $settings->duration_typography_line_height['small'] != '' ) { ?>
				line-height: <?php echo $settings->duration_typography_line_height['small']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->duration_typography_line_height_unit_responsive ) && $settings->duration_typography_line_height_unit_responsive != '' ) : ?>
		...
		.fl-node-<?php echo $id; ?> .uabb-pricing-table li {
			...
			<?php if( isset( $settings->feature_typography_font_size_unit_responsive ) && $settings->feature_typography_font_size_unit_responsive == '' && isset( $settings->feature_typography_font_size['small'] ) && $settings->feature_typography_font_size['small'] != '' ) { ?>
				font-size: <?php echo $settings->feature_typography_font_size['small']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->feature_typography_font_size_unit_responsive ) && $settings->feature_typography_font_size_unit_responsive != '' ) : ?>
			...
			<?php if( isset( $settings->feature_typography_line_height_unit_responsive ) && $settings->feature_typography_line_height_unit_responsive == '' && isset( $settings->feature_typography_line_height['small'] ) && $settings->feature_typography_line_height['small'] != '' ) { ?>
				line-height: <?php echo $settings->feature_typography_line_height['small']; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->feature_typography_line_height_unit_responsive ) && $settings->feature_typography_line_height_unit_responsive != '' ) : ?>
		...
		.fl-node-<?php echo $id; ?> .uabb-pricing-table .uabb-pricing-table-column .uabb-pricing-table-features .uabb-pricing-ledgend {
			...
			<?php if( isset( $settings->legend_column->legend_font_size_unit_responsive ) && $settings->legend_column->legend_font_size_unit_responsive == '' && isset( $settings->legend_column->legend_font_size->small ) && $settings->legend_column->legend_font_size->small != '' ) { ?>
				font-size: <?php echo $settings->legend_column->legend_font_size->small; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->legend_column->legend_font_size_unit_responsive ) && $settings->legend_column->legend_font_size_unit_responsive != '' ) : ?>
			...
			<?php if( isset( $settings->legend_column->legend_line_height_unit_responsive ) && $settings->legend_column->legend_line_height_unit_responsive == '' && isset( $settings->legend_column->legend_line_height->small ) && $settings->legend_column->legend_line_height->small != '' ) { ?>
				line-height: <?php echo $settings->legend_column->legend_line_height->small; ?>px;
			<?php } else { ?>
				<?php if( isset( $settings->legend_column->legend_line_height_unit_responsive ) && $settings->legend_column->legend_line_height_unit_responsive != '' ) : ?>
