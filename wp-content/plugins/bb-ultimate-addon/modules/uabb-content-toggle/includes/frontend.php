	...
	<div class="uabb-rbs-toggle">
		...
		<div class="uabb-main-btn" data-switch-type="<?php echo $settings->select_switch_style; ?>">
			...
			switch ( $settings->select_switch_style ) {
				case 'round1':
					$switch_html = '<label class="uabb-rbs-switch-label"><input type="checkbox" class="uabb-rbs-switch uabb-switch-round-1 uabb-clickable" ' . $is_checked . '><span class="uabb-rbs-slider uabb-rbs-round uabb-clickable switch1"></span></label>';
					break;

				case 'round2':
					$switch_html = '<div class="uabb-toggle"><input class="uabb-switch-round-2 uabb-clickable" type="checkbox" name="group1" id="toggle" ' . $is_checked . '><label for="toggle" class="uabb-clickable switch2"></label></div>';
					break;

				case 'rectangle':
					$switch_html = '<label class="uabb-rbs-switch-label"><input type="checkbox" name="uabb-label-box" id="myonoffswitch" class="uabb-rbs-switch uabb-switch-rectangle uabb-clickable" ' . $is_checked . '><span class="uabb-rbs-slider switch3"></span></label>';
					break;
